...
public class ChatMessageVO {
    ...
    // ========== 补充注释：明确多附件格式 ==========
    private String attachmentPath; // 附件路径（多张用逗号分隔，存储对象存储地址，如OSS/MinIO的URL）
    private String content; // 消息内容（附件消息时可填附件说明，如"图片1张"）
    private String msgType; // 消息类型 TEXT-文本，ATTACHMENT-附件，PAY_REMIND-付款提醒，SYSTEM_TIP-系统提示
